/* =============================================
   HANDS-ON SESSION — PRESENTATION ENGINE
...
const STORAGE_KEY = 'slide-pos-handson';
...
function updateHUD() {
    ...
    document.title = `Hands-On · Slide ${currentIndex + 1}/${slides.length} — Smart License Plate Recognition`;
}
